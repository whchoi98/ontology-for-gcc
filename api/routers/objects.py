...
def _synthesize_items(label: str, limit: int) -> list[dict]:
    ...
    if label == "Manufacturer":
        return [
            {"id": "AMZN-GCC-HA",      "name": "AMZN Tech Home Appliance",     "division": "HA"},
            {"id": "AMZN-GCC-HE",      "name": "AMZN Tech Home Entertainment", "division": "HE"},
            {"id": "AMZN-GCC-VS",      "name": "AMZN Tech Vehicle Solutions",  "division": "VS"},
            {"id": "AMZN-GCC-INNOTEK", "name": "AMZN Tech Innotek + Magna ePT JV", "division": "INNOTEK"},
        ]
