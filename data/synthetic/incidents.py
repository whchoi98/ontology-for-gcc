...
The scenario J demo targets `INC-2026-0412 BGA solder ball crack`,
seeded as a fixed entry (spec § 8.6 Demo fixture tuning).
"""
...
def generate_incidents(*, component_ids: list[str], supplier_ids: list[str], plant_ids: list[str], seed: int = 42) -> dict[str, list]:
    ...
    # Scenario J demo fixture — direct constructor, no model_dump round-trip
