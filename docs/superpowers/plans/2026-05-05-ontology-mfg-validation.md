...
- Cognito demo: `demo@whchoi.net` / `!234Qwer`
...
- [ ] mfg 데모 https://mfg-ontology.whchoi.net/ 로그인 가능 (demo@whchoi.net / !234Qwer)
...
## Live URLs
- App: https://mfg-ontology.whchoi.net (Cognito demo@whchoi.net / !234Qwer)
