...
Custom domain: `https://mfg-ontology.whchoi.net`. Demo users: `admin@whchoi.net` / `demo@whchoi.net` (PW `!234Qwer`).
...
export class EdgeStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: EdgeStackProps) {
    ...
    // Custom resource — set permanent password `!234Qwer` (admin-set, suppress reset)
